...
public class Constants {
    ...
    public static final String bcpuTotal = "cpuTotalD";

    public static final String bcpuMy = "cpuMyD";

    public static final String bMemUsed = "memUsedD";
    public static final String bMemAvailable = "memAvailableD";
    public static final String bMemFree = "memFreeD";
    public static final String bCached = "cachedD";
    public static final String bThreshold = "thresholdD";
